"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5377],{5377:(e,t,i)=>{i.r(t),i.d(t,{AppKitModal:()=>ev,W3mModal:()=>em,W3mModalBase:()=>eh});var o=i(44764),a=i(60097),r=i(74410),s=i(75941),n=i(63084),c=i(53236),l=i(39018),w=i(86972),d=i(36139),p=i(64860),u=i(15922);let h={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView()||await u.U.isSIWXCloseDisabled())return void c.W.shake();c.W.close()}};var m=i(42470),v=i(47005),g=i(63926),y=i(38906),f=i(39264),b=i(1771);let k=(0,o.AH)`
  :host {
    display: block;
...
`,(0,o.qy)`
    ...
    `}};j.styles=[f.W5,f.fD,f.ck,P],D([(0,a.MZ)()],j.prototype,"size",void 0),D([(0,a.MZ)({type:Boolean})],j.prototype,"disabled",void 0),D([(0,a.MZ)()],j.prototype,"icon",void 0),D([(0,a.MZ)()],j.prototype,"iconColor",void 0),j=D([(0,b.E)("wui-icon-link")],j),i(46191),i(57619);let H=(0,o.AH)`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var M=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let B=class extends o.WF{constructor(){super(...arguments),this.imageSrc=""}render(){return(0,o.qy)`<button>
    ...
    ></wui-icon-box>`}};B.styles=[f.W5,f.fD,f.ck,H],M([(0,a.MZ)()],B.prototype,"imageSrc",void 0),B=M([(0,b.E)("wui-select")],B),i(5428),i(35687);var L=i(38593);let z=(0,o.AH)`
  :host {
    height: 64px;
  }
